#!/usr/bin/env python3
"""
analyze_chunked.py - Analise de cortes virais com chunking

Divide a transcricao em chunks de ~3 minutos, analisa cada chunk
...
from analysis_prompts import build_chunk_prompt
...
def main():
    ...
    chunks = create_chunks(transcription, CHUNK_DURATION_LONG)
    ...
    for chunk in chunks:
        ...
        try:
            ...
            all_warnings.append(f"Erro no chunk {chunk['chunk_id']}: {exc}")
    ...
    final_result = {
        ...
        "chunking_info": {
            ...
            "chunk_duration_sec": CHUNK_DURATION_LONG,
